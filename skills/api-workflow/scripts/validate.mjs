...
const MODES = ['storage-state', 'persistent-profile', 'localhost-cdp'];
...
const REQUIRED = [
  ...
  'references/hybrid-patterns/api-auth-browser-session.md',
  'templates/fixtures/browser-session.storage-state.ts',
  'templates/fixtures/browser-session.persistent-profile.ts',
