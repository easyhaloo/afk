...
function record(value: unknown): AppServerEventObject {
  return value !== null && typeof value === 'object' ? value as AppServerEventObject : {};
}
...
function errorMessage(value: AppServerEventObject): string {
