...
function record(value: unknown): RuntimeObject {
  return value !== null && typeof value === 'object' ? value as RuntimeObject : {};
}
...
function check(
  checks: RuntimeObject,
  id: string,
): { status?: string; details?: RuntimeObject } | undefined {
